...
from infrastructure.repositories.db_models import organizations, vehicles
...
class VehiclesRepository:
    ...
    async def create_org_if_not_exists(self, org_id: UUID):
        select_query = select(organizations.c.id).where(organizations.c.id == org_id)
        ...
        org_data = {
            ...
            organizations.c.name: "test_org",
            organizations.c.created_at: datetime.now(),
            organizations.c.created_by: "admin",
            organizations.c.updated_at: datetime.now(),
            organizations.c.updated_by: "admin",
        }

        query = organizations.insert(org_data)
